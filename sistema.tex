...
actual del juego, el primer paso es escribir diferentes órdenes de prioridad acordes a dichas fases. Es decir, el sistema de resolución propuesto permite
...
modo. Los órdenes de prioridad escritos indicarán la importancia de las posibles intenciones de los agentes en una fase determinada del juego.
